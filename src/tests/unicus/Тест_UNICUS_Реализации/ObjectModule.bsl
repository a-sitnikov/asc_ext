...
Процедура Реализация_ОплатаВБанке() Экспорт
	...
	Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДокументСсылка, "РучнаяКорректировка");
	Утверждения.ПроверитьИстину(Реквизиты.РучнаяКорректировка, "Не указан ручная корректировка");
	
	ТитПлатежа = УправлениеСвойствами.ЗначениеСвойства(ДокументСсылка, "ТипПлатежа");
	Утверждения.ПроверитьРавенство(Строка(ТитПлатежа), "Оплата в Банке",  "Не указан комментарий");
...
Процедура РТУ_ИзменениеТипаПлатежа() Экспорт
	...
	Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДокументСсылка, "РучнаяКорректировка, СуммаДокумента");
	Утверждения.ПроверитьРавенство(Реквизиты.РучнаяКорректировка, Истина,  "Не верная ручная корректировка");
	Утверждения.ПроверитьРавенство(Реквизиты.СуммаДокумента,      1120.1,  "Не верная сумма документа");
	...
	Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДокументСсылка, "РучнаяКорректировка, СуммаДокумента");
	Утверждения.ПроверитьРавенство(Реквизиты.РучнаяКорректировка, Ложь,  "Не верная ручная корректировка");
	Утверждения.ПроверитьРавенство(Реквизиты.СуммаДокумента,      11200.96,  "Не верная сумма документа");
