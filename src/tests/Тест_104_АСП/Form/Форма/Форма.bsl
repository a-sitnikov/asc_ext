...
Процедура ЗаполнитьНаборТестов(НаборТестов) Экспорт
	...
	//ТАГ_АУД
	НаборТестов.НачатьГруппу("Тест_104_АСП", Истина);
	НаборТестов.Добавить("Тест_104_АСП_Январь");
	НаборТестов.Добавить("Тест_104_АСП_Февраль");
...
&НаКлиенте
Процедура Тест_104_АСП_Январь() Экспорт
	...
	Форма.тестУстановитьЗначениеОбласти("СкладТрейдИн_План", 10);
...
&НаКлиенте
Процедура Тест_104_АСП_Февраль() Экспорт
	...
	// Тк ячейки ссылаются на пред. периоды, то нужно предварительно заполнить
