...
Функция ПолучитьДанныеЮникус(АдресХранилища)
	...
	Пока Истина Цикл
		...
		Договор = СтрЗаменить(СокрЛП(ТабДок.Область(Счетчик, 35).Текст), Символы.НПП, " "); 
		...
		Если ЗначениеЗаполнено(Договор)
			...
			НоваяСтрока.ДЦ            = АСЦ_ПоискОбъектов.ПолучитьОбъектПоСоотвествию(ДЦ, ДопПараметры.НастройкаДепартаменты, База, КэшДанных.Департамент);
...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	АдресХранилища = КомпоновщикНастроек.ПользовательскиеНастройки.ДополнительныеСвойства.АдресХранилища;
