...
Процедура Загрузить(Параметры, АдресРезультата) Экспорт
	...
	СформироватьБухДокументы(МассивЭкзОтчетов, Параметры.ПерезаполнятьДокументы);
...
Функция ПолучитьЭкземплярыОтчетов(Период, Организация)
	...
	Запрос.Параметры.Вставить("ВидОтчета",   "UNICUS_Contracts");
...
Функция СформироватьБухДокументы(МассивЭкзОтчетов, ПерезаполнятьДокументы)
	...
	Для каждого ДокументСсылка из МассивЭкзОтчетов Цикл
		...
		Для каждого СтрокаТЗ из ТаблицаДанных Цикл
			...
			СоздатьДокумент(Организация, СтрокаТЗ, ПерезаполнятьДокументы);
...
Функция СоздатьДокумент(Организация, Параметры, ПерезаполнятьДокументы)
