...
Процедура ЗаполнитьСвязанныеДокументыОтчетПосредника(ДокОбъект)
		...
		Для каждого СтрокаТЗ из ТаблицаДанных Цикл
			...
			Если ЗначенияОтличаются(ПредЗначения, СтрокаТЗ) Тогда
				...
				Если ДокОбъект <> Неопределено Тогда
					...
					ДокОбъект.Контрагент  = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СтрокаТЗ.ДоговорСК, "Владелец");
