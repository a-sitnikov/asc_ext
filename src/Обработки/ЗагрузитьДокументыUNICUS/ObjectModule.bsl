...
// В УПП эта обработка называется
// Загрузка полисов В УПП с ИНН и КПП
...
Процедура ЗагрузитьActs(Параметры, АдресРезультата) Экспорт
	...
	МассивЭкзОтчетов = ПолучитьЭкземплярыОтчетов(Параметры.Период, Параметры.Организация, ВидОтчета);
	СформироватьДокументыОтчетКомиссионера(МассивЭкзОтчетов, Параметры.ПерезаполнятьДокументы);
...
Функция СформироватьДокументыОтчетКомиссионера(МассивЭкзОтчетов, ПерезаполнятьДокументы)
	...
	Для каждого ДокументСсылка из МассивЭкзОтчетов Цикл
		...
		Для каждого СтрокаТЗ из ТаблицаДанных Цикл
			...
			Если ЗначенияОтличаются(ПредЗначения, СтрокаТЗ) Тогда
				...
				ДокОбъект = СоздатьДокументОтчетКомиссионера(Организация, СтрокаТЗ, ПерезаполнятьДокументы);
...
Функция СоздатьДокументОтчетКомиссионера(Организация, Параметры, ПерезаполнятьДокументы)
