...
Процедура ВыгрузитьДокументы(Параметры, АдресРезультата = Неопределено) Экспорт
	...
	|ГДЕ
	|	Рег.НастройкаСоответствия = &НастройкаСоответствия
	|{ГДЕ
	|	Рег.ИспользуемаяИБ,
	...
	Запрос.Параметры.Вставить("НастройкаСоответствия", Справочники.СоответствиеВнешнимИБ.НайтиПоНаименованию("Реализация ОФУ"));
