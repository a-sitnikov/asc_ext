...
Функция ПолучитьТаблицуДанных(База, ДатаНач, ДатаКон, ОтборОрганизация = Неопределено, ОтборID = Неопределено, Тест_КоличествоСтрок = Неопределено)
...
Функция ПолучитьТаблицуДанныхТест()
...
Процедура ЗагрузитьОтчеты(Параметры, АдресРезультата = Неопределено) Экспорт
	...
	ТаблицаДанных = ПолучитьТаблицуДанных(База, ДатаНач, ДатаКон, ОтборОрганизация, ОтборID, Тест_КоличествоСтрок);
