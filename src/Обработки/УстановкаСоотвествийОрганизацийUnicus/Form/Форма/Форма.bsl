...
Процедура ПрочитатьНаСервере()
	...
	Пока НЕ мНаборЗаписей.EOF Цикл
		...
		НоваяСтрока.Наименование = мНаборЗаписей.Fields("AGENT").Value;
	...
	Настройка = Справочники.СоответствиеВнешнимИБ.НайтиПоНаименованию("AGENTS <-> Организации",, База.Владелец);
...
Функция ПолучитьОрганизацию(Наименование, Настройка)
	...
	Запрос = Новый Запрос;
	Запрос.Параметры.Вставить("Наименование", Лев(Наименование, 150));
...
Процедура ЗаписатьНаСервере()
	...
	Для каждого СтрокаТЗ из ТаблицаДанных Цикл
		...
		Запись.ОбъектВнешнейИБ = Лев(СтрокаТЗ.Наименование, 150);
