...
Функция ЗаполнитьАналитику(Таблица)
	...
	Для каждого СтрокаТЗ из Результат Цикл
		...
		Комментарий = Формат(СтрокаТЗ.ДатаДок, "ДФ=dd.MM.yyyy") + " $ " + СтрокаТЗ.СК_Договор;
		СтрокаТЗ.Аналитика4 = ПолучитьАкт(СубконтоАкт, СтрокаТЗ.act_id, СтрокаТЗ.НомерДок, Комментарий);
