...
Процедура ЗаполнитьОтчет(ДокОбъект) Экспорт
	...
	Для каждого СтрокаТЗ из Результат Цикл
		...
		Для каждого Колонка из Колонки Цикл
			...
			Если Код = "СтрахованиеЖизни_" Тогда
				// страхование жизни не разбивается
				
			ИначеЕсли СтрокаТЗ.Пролонгация = 1 Тогда
				Код = Код + "Пролонгация_" + Колонка;
				
			ИначеЕсли СтрокаТЗ.TS_NEW = 0 Тогда	
				Код = Код + "БУ_" + Колонка;
				
			Иначе
				Код = Код + "Розница_" + Колонка;
			КонецЕсли;	
