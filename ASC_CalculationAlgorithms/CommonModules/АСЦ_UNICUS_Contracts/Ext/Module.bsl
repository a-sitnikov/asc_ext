...
Функция ЗаполнитьАналитику(Таблица, Организация)
	...
	СвойствоИД = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоРеквизиту("Имя", "НаименованиеUNICUS");
	...
	Для каждого СтрокаТЗ из Результат Цикл
		...
		СтрокаТЗ.Аналитика3 = ПолучитьНоменклатуру(СтрокаТЗ.PRODUCT_NAME, КэшНоменклатуры);
		СтрокаТЗ.Аналитика4 = ПолучитьОрганизацию(СтрокаТЗ.DEPARTMENT_NAME, СвойствоИД, КэшОрганизаций);
...
Функция ПолучитьОрганизацию(Наименование, Свойство, Кэш)
