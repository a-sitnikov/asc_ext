...
Функция ПолучитьКонтрагента(Данные, Параметры, Перезаписывать = Ложь) Экспорт
	...
	Если ЗначениеЗаполнено(Данные.КонтрагентГУИД) Тогда
		...
		ГУИД = Новый УникальныйИдентификатор(Данные.КонтрагентГУИД);
	...
	Иначе	
		...
		Если ЗначениеЗаполнено(Данные.КонтрагентГУИД) Тогда
			СпрОбъект.УстановитьСсылкуНового(Новый УникальныйИдентификатор(Данные.КонтрагентГУИД));
		КонецЕсли;
...
Функция НайтиДокументПоСвойству(Значение, Свойство, ТипДокумента) Экспорт
	...
	|	И Рег.Объект ССЫЛКА Документ." + ТипДокумента;
