...
Процедура УстановитьСостояниеДокумента()
	...
	Для каждого СтрокаТЧ из Объект.Продажи Цикл
		...
		РеквизитыДокумента = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(СтрокаТЧ.Документ, "Проведен, ПометкаУдаления");
		СтрокаТЧ.СостояниеДокумента = ОбщегоНазначенияБП.СостояниеДокумента(РеквизитыДокумента);
